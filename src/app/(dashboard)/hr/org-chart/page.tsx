    ...
    return (
        <div className="relative">
            ...
            >
                {/* Connector line */}
                {level > 0 && (
                    <div className="absolute left-0 top-0 bottom-0" style={{ left: `${(level * 8) + 24}px` }}>
                ...
                <Card className="border shadow-sm hover:shadow-md transition-all flex-1 max-w-md">
                    <CardContent className="p-3">
                        <div className="flex items-center gap-3">
                            ...
                            {/* Avatar */}
                            <div className="w-10 h-10 rounded-full bg-gradient-to-br from-violet-500 to-purple-600 flex items-center justify-center text-white font-bold text-sm shadow-sm shrink-0">
                ...
                <div className="flex items-center gap-3">
                    ...
                    <div>
                        ...
                        <p className="text-muted-foreground text-sm mt-0.5">
                            Şirket hiyerarşisi ve ekip yapısı
                        </p>
                    </div>
                </div>
